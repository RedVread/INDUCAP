...
<body>
    ...
    <div class="bg-white">
            ...
            <div class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
              ...
              <div class="mt-6 flow-root">
                <div class="-my-6 divide-y divide-gray-500/10">
                  ...
                  <div class="py-6">
                    <a href="#" class="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">Contacte</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
          ...
          <?php include '../PHP/loadAllCars.php'; ?>


            <!-- <div class="text-center">
              <h1 class="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">Somia el teu cotxe. Condueix-lo.</h1>
              <p class="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">Tenim una selecció de cotxes clàssics tan gran, que estem segurs que tenim el que estàs buscant.</p>
              <div class="mt-10 flex items-center justify-center gap-x-6">
                <a href="#" class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Explora</a>
                <a href="#" class="text-sm/6 font-semibold text-gray-900">Buscar<span aria-hidden="true">→</span></a>
              </div>
            </div> -->
          </div>
